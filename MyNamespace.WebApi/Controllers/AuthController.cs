...
namespace MyNamespace.WebApi.Controllers
{
    public class AuthController : ApiController
    {
        ...
        public AuthController(AppContext appContext, IBaseUnitOfWork unitOfWork1, IUserRepository userRepository, IUserDetailsRepository userDetailsRepository, ISignInManager singInManager, IUserManager userManager)
        {
